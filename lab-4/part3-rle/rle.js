...
//const input = "aaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaabbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbccccccccccccccccccccccccccccc";
//const input = "a".repeat(600) + "b".repeat(20) + "c".repeat(60);
const input = "poiuytrewqasdfgjklmnbvcz";
